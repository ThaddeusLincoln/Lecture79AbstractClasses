...
public class SearchTree implements NodeList  {
	...
	public void traverse(ListItem root) {
		...
		if(root != null){
			traverse(root.previous()); // refers to the method in the left
	...
	/**
	 * Actually removeItem() only determines the node to be removed, 
	 * it's in this method where the work is really done.
	 */
